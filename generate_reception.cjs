...
export const ReceptionDailyReport: React.FC = () => {
    ...
    return (
        <div className="flex flex-col h-full bg-slate-950 text-slate-200 w-full animate-fade-in">
            <div className="flex-1 w-full space-y-6">
                ...
                <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 w-full">
                    ...
                    <div className="xl:col-span-4 flex flex-col h-full space-y-6">
                        ...
                        <div className="glass-panel p-6 rounded-3xl border border-white/5 relative overflow-hidden flex-shrink-0 group">
                        ...
                        {loading ? (
                            ...
                            <div className="glass-panel rounded-3xl border border-white/5 flex flex-col flex-1 overflow-hidden">
                        ...
                        <div className="flex flex-col">
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-6">
                                <div className="glass-panel p-6 rounded-3xl border border-white/5 relative overflow-hidden group">
                                    ...
                                    <span className="text-[10px] text-blue-400 font-bold uppercase tracking-widest mb-1 block">Agendamentos Fim do Dia</span>
                                    <div className="flex items-end gap-2">
                                        <span className="text-3xl font-black text-white">{kpiMetrics.agendamentosTotal}</span>
