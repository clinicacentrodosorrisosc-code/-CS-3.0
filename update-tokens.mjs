...
async function run() {
  ...
  // Tentar atualizar um registro existente em vez de inserir, 
  // talvez a política de RLS de update seja diferente da de insert
  const { data, error } = await supabase.from('kommo_tokens').update({
