    ...
    return (
        <div className="flex flex-col h-full w-full animate-fade-in text-slate-200">
            <div className="flex-1 w-full space-y-6">
                ...
                {message && (
                    <div className={`p-4 rounded-2xl border ${message.type === 'success' ? 'bg-blue-500/10 border-blue-500/20 text-blue-400' : 'bg-rose-500/10 border-rose-500/20 text-rose-400'} flex items-center justify-between shadow-lg backdrop-blur-2xl animate-in zoom-in duration-300`}>
                    ...
                    <div className="xl:col-span-5 flex flex-col space-y-6">
                            ...
                            <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                                ...
                                <div className="flex flex-col gap-1 shrink-0">
                                    <div className="relative">
                                        <CalendarIcon className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-purple-400 pointer-events-none" />
                                        <input
                                            type="date"
                                            value={reportDate}
                                            onChange={(e) => setReportDate(e.target.value)}
                                            className="bg-panel border border-border rounded-xl pl-10 pr-4 py-2 text-text focus:border-purple-500 focus:ring-1 focus:ring-purple-500/20 outline-none transition-all font-semibold font-sans text-xs shadow-inner cursor-pointer"
                                        />
                                    </div>
                                </div>
                            </div>
                        ...
                        {loading ? (
                            <div className="glass-panel rounded-3xl border border-border bg-white/[0.01] p-12 flex flex-col items-center justify-center min-h-[400px]">
                                <div className="w-10 h-10 rounded-full border-4 border-purple-500/15 border-t-purple-500 animate-spin mb-4" />
                            ...
                            <div className="glass-panel rounded-3xl border border-border flex flex-col overflow-hidden bg-white/[0.01]">
                                    ...
                                    <div className="flex items-center gap-2">
                                        {(appointmentData as any)[reportDate] && (
                                            <button
                                                ...
                                                className="flex items-center gap-1.5 px-3 py-1 bg-purple-500/20 hover:bg-purple-500/30 text-purple-300 text-[10px] font-bold rounded-lg border border-purple-500/30 transition-all cursor-pointer"
                                            >
                                ...
                                <div className="p-6 space-y-4 flex-1">
                                            ...
                                            <div>
                                                ...
                                                <div className="mt-2 flex items-center gap-2">
                                                    <div className="h-1 w-24 bg-panel/80 rounded-full overflow-hidden">
                                                        <div className={`h-full rounded-full ${ (answers.q2_atendimentos_finalizados || 0) >= 15 ? 'bg-blue-500' : 'bg-blue-400'}`} style={{ width: `${Math.min((answers.q2_atendimentos_finalizados || 0) / 15 * 100, 100)}%` }} />
                                                    </div>
                                                    <span className={`text-[9px] font-bold ${ (answers.q2_atendimentos_finalizados || 0) >= 15 ? 'text-blue-400' : 'text-slate-400'}`}>
                                    ...
                                    <div className="p-4 rounded-2xl bg-white/[0.02] border border-border hover:border-border transition-all flex flex-col gap-3 relative overflow-hidden group">
                                        ...
                                        <textarea
                                            ...
                                            className="bg-panel border border-border rounded-xl px-4 py-3 text-text focus:border-blue-500 outline-none text-sm font-bold w-full font-mono min-h-[80px]"
                                ...
                                <div className="p-4 border-t border-border bg-panel flex flex-col sm:flex-row gap-3">
                                    ...
                                    <button
                                        ...
                                        disabled={saving}
                                        className="flex-1 glass-button bg-blue-600/20 border-blue-500/30 text-text font-black py-3.5 rounded-xl transition-all shadow-lg flex items-center justify-center gap-2 text-xs uppercase tracking-widest active:scale-[0.98] cursor-pointer"
                                    >
                                ...
                                {[
                                    ...
                                    <button
                                        ...
                                        className={`px-3 py-1.5 rounded-lg text-[11px] font-bold transition-all glass-button ${
                                            dateRange === range.id
                                                ? 'bg-purple-600 text-text shadow-lg shadow-purple-500/20'
                                ...
                                <div className="flex items-center gap-2 animate-in fade-in slide-in-from-left-2 duration-300">
                                    <div className="flex flex-col gap-1">
                                        <input
                                            ...
                                            className="bg-panel border border-border rounded-lg px-3 py-1 text-[11px] text-text outline-none focus:border-purple-500 cursor-pointer"
                                        />
                                    </div>
                                ...
                                <div className="mb-4">
                                    <div className="flex justify-between items-end mb-2">
                                        <div className="flex flex-col">
                                            <span className="text-[9px] text-purple-400 font-extrabold uppercase tracking-widest">Comparecimentos</span>
                                    ...
                                    <div className="flex h-2.5 w-full rounded-full overflow-hidden bg-slate-800">
                                        <div style={{ width: `${kpiMetrics.attendanceRate}%` }} className="bg-purple-400 h-full transition-all duration-500" title="Compareceram"></div>
                                                             ...
                                                             <td className="py-2.5 px-3">
                                                                 <div className="flex items-center justify-center gap-2">
                                                                     <button
                                                                         ...
                                                                         className="p-1 text-slate-400 hover:text-purple-400 transition-colors cursor-pointer"
                                                                     >
