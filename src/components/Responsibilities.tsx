      ...
      <div className="flex-1 flex flex-col min-w-0 bg-transparent relative">
        ...
        {printData && (
          <div id="print-section" className="hidden print:block absolute inset-0 bg-white text-[#1e293b] p-12 z-[999999]">
            ...
            <div className="mb-6">
              <h3 className="text-xs font-semibold text-[#0d9488] mb-2 leading-none">Objetivo e Diretriz</h3>
            ...
            <div>
              <h3 className="text-xs font-semibold text-[#0d9488] mb-4 leading-none">Passo a Passo Prático</h3>
        ...
        <div className="flex-1 overflow-y-auto px-4 lg:px-6 py-4 custom-scrollbar relative z-10 w-full">
           <div className="w-full min-h-full space-y-10 relative z-10">
               ...
               <div className="flex flex-col gap-6 mb-2">
                   <div>
                       <h1 className="text-2xl md:text-3xl font-semibold text-text bg-transparent outline-none w-full block resize-none leading-tight tracking-tight mb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            <div className="bg-surface border border-border rounded-2xl p-5 flex items-center gap-4">
              ...
              <div className="min-w-0 flex-1">
                ...
                <span className="text-[10px] text-purple-400 font-semibold block font-mono mt-0.5">
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-6 md:p-8 space-y-6 custom-scrollbar text-xs">
                ...
                <div className="space-y-2">
                  <h4 className="text-[10px] font-semibold text-purple-400 font-sans">Objetivo do Procedimento</h4>
                ...
                <div className="space-y-4">
                  <h4 className="text-[10px] font-semibold text-purple-400 font-sans">Instruções Passo a Passo</h4>
