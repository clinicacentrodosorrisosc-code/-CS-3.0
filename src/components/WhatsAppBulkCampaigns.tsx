      ...
      <div className="mt-5 grid gap-5 lg:grid-cols-[minmax(0,1fr)_320px]">
        <main className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-5 shadow-sm">
          ...
          {preview && <section className="mt-5 rounded-2xl bg-[var(--bg-subtle)] p-4">
            ...
            <label className="mt-4 block text-xs font-semibold"><span className="flex items-center gap-1.5"><Tag className="h-3.5 w-3.5" />Observação após envio confirmado</span><input value={successTag} onChange={event => setSuccessTag(event.target.value)} maxLength={240} placeholder="Ex.: Campanha retorno" className="mt-1.5 h-10 w-full rounded-xl border border-[var(--border)] bg-[var(--surface)] px-3 outline-none focus:border-[var(--primary)]" /></label>
