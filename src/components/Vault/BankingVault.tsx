...
const BANK_COLORS = [
  ...
  { name: 'Sicoob / Sicredi Verde', bg: 'from-blue-950/70 to-slate-950/90 border-blue-500/30' }
];
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-surface/60 border border-border p-4 md:p-6 rounded-3xl backdrop-blur-sm">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-bold flex items-center gap-2 shadow-lg shadow-blue-900/40 transition-all active:scale-95"
            >
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="text-sm font-bold text-text uppercase tracking-widest flex items-center gap-2">
              <Building2 className="w-4 h-4 text-blue-400" /> Contas Bancárias Cadastradas ({bankAccounts.length})
            </h3>
          </div>
                  ...
                  <div className="grid grid-cols-2 gap-3 mb-3">
                    <div className="bg-black/30 backdrop-blur-md p-3 rounded-2xl border border-white/10">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        >
                          {copiedKey === bank.id + '_ag' ? <Check className="w-3.5 h-3.5 text-blue-400" /> : <Copy className="w-3.5 h-3.5" />}
                        </button>
                      </div>
                    </div>
                    ...
                    <div className="bg-black/30 backdrop-blur-md p-3 rounded-2xl border border-white/10">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button
                          ...
                          title="Copiar Conta"
                        >
                          {copiedKey === bank.id + '_cc' ? <Check className="w-3.5 h-3.5 text-blue-400" /> : <Copy className="w-3.5 h-3.5" />}
                        </button>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-2">
                    {bank.document && (
                      <div className="bg-black/20 p-2.5 rounded-xl border border-white/5 flex items-center justify-between">
                        ...
                        >
                          {copiedKey === bank.id + '_doc' ? <Check className="w-3 h-3 text-blue-400" /> : <Copy className="w-3 h-3" />}
                        </button>
                      </div>
                    )}

                    {bank.pixKey && (
                      <div className="bg-blue-950/40 p-2.5 rounded-xl border border-blue-500/20 flex items-center justify-between">
                        <div className="flex items-center gap-2 min-w-0 flex-1">
                          <QrCode className="w-4 h-4 text-blue-400 flex-shrink-0" />
                          <div className="min-w-0 flex-1">
                            <span className="text-[9px] font-bold text-blue-400 uppercase tracking-wider block">Chave Pix ({bank.pixType || 'Pix'})</span>
                        ...
                        <button
                          ...
                          className="px-2.5 py-1 bg-blue-500/20 hover:bg-blue-500/40 text-blue-300 rounded-lg text-xs font-bold flex items-center gap-1 transition-colors"
                        >
                          {copiedKey === bank.id + '_pix' ? <Check className="w-3 h-3 text-blue-300" /> : <Copy className="w-3 h-3" />}
          ...
          <div className="bg-surface border border-border rounded-3xl w-full max-w-lg overflow-hidden shadow-2xl animate-in zoom-in-95 duration-200">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full bg-panel border border-border rounded-xl px-3 py-2 text-xs text-text outline-none focus:border-blue-500/50"
                  />
                </div>
                <div className="space-y-1">
                  ...
                  {BANK_COLORS.map(c => (
                    <button
                      ...
                      className={`h-8 rounded-xl border bg-gradient-to-r ${c.bg} ${
                        bankFormData.color === c.bg ? 'ring-2 ring-blue-400' : 'opacity-70 hover:opacity-100'
                      }`}
                      title={c.name}
                    />
                  ))}
            ...
            <div className="p-4 border-t border-border bg-panel flex justify-end gap-2">
              ...
              <button
                ...
                className="px-5 py-2 bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white rounded-xl text-xs font-bold shadow-md"
              >
                Salvar Conta
              </button>
            </div>
